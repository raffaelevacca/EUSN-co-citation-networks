...
legend <- expression(legend(2.3, -0.9, legend= c(expression(bold("Author cited in:")), "Social Sciences", "Computer Science/Physics", "Both"), pch= c(NA, 21, 21, 21), col= c(NA, v.f.col), pt.bg= c(NA, v.col), bty="n", cex= 5, pt.cex=6, x.intersp= 0.2, y.intersp= 0.3))
